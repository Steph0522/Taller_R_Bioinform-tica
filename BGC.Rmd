...
---
## Minería genómica
- Los esfuerzos en descubrimientos de fábricos se han basado en un "screening" de compuestos bioactivos de plantas, hongos y bacterias.
...
En un pangenoma cerrado, el pool permaece estable relativamente y limitado, indicando un bajo grado de diversidad genómica dentro de las especies. 
]
...
- Difiere de antismash que lo hace a ciegas del conocimiento prevo de las enzimas biosintéticas de NPs. Require una revisión profunda de las prediciones de genes realizada porque puede aumentar la tasa de falsos positivos.
- Requiere igual un lineaje taxonómico que ha sido minado con información genómica significativa.

- En la práctica, Evomining reconstruye un árbol filogénetico con todos las secuencias ortólogas encontradas en GDB que permite visualiar la historia evolutiva de una familia de enzimas de determinada.
---
# Redes de simiitud de BGCs

- En caso de que se quiera estudiar cierto BGC o cierta cepa con antiSMASH será suficiente. 

- Sin embargo, a vece el objetivo es compara el potencial biosintético de 10 o de 100 genomas. 

- Cuando se tienen tantos o suficiente, puede ser útil realizar redes de similitud usando BiG-SCAPE (Navarro-Muñoz et al., 2019),

- Una vez se identifican los BGCs conviene compararlos con los de otras bases de datos y organismos. Estas comparaciones globales pueden identificar eventos evolutivos putativos y revela el conteimdo de genes o dominios para conocer el BGC
...
- Se construye un árbol filogéntico. No tendrá en cuenta genomas que le falten uno de los genes conservados definidos por el susario. 

---

# CORASON

- Por lo que el usuario debe definir el gen del core crucial el cual determina la venataja del análisis filogenétiicos. Se recomienda evitar PKS, NRPS incluso si son conservados porque están sobre representados en genomas bacterianos. 
